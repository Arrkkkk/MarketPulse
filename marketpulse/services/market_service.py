...
DEFAULT_STOCK_SYMBOLS: tuple[str, ...] = (
    ...
    "DIS", "NKE", "V", "PG", "COST", "TCS.NS", "HDFCBANK.NS", "BARC.L",
    "SHEL.L", "MBG.DE", "RY.TO",
)

DEFAULT_CRYPTO_IDS: tuple[str, ...] = (
    "bitcoin", "ethereum", "ripple", "cardano", "solana", "dogecoin",
    "litecoin", "polkadot", "binancecoin", "tron", "shiba-inu",
)
...
class MarketService:
    ...
    def get_quote(self, symbol: str, period: str = "5d") -> Quote | None:
        ...
        return history.to_quote(currency=profile.currency if profile else "USD")
